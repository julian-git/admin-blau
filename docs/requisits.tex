...
\begin{description}
\item[Persones] \complert
\item[Categories de persones] \complert
\item[Rols] \complert; sense funcionalitat
\item[Famílies] \complert
\item[Quotes] \complert
\item[Esdeveniments] \progres \falta preus
\item[Compte] \falta
\item[Rebuts] \progres \falta mail, cobrament manual, històric de pagaments
\end{description}
...
\item[R01] \complert Alta, baixa i modificació de persones 

\begin{itemize}
\item \progres Un administrador ha de poder accedir a una part privada per afegir, editar i eliminar persones a la base de dades. 
\item \complert Quan es doni d'alta una persona, enviar-li un mail informant-lo de l'alta i se li adjunten les dades per a que les comprovi. 
\item \complert Quan es doni de baixa algú, enviar també mail informant. 
\item \complert S'ha de preguntar cada vegada a l'administrador si
  enviar o no aquests mails.
\item \falta rols
\end{itemize}
...
\item \complert Quan es doni d'alta una família, avisar a tots els responsables de que se'ls ha agrupat en una família per mail. 
\item \complert El mateix quan es doni de baixa. 
\item \complert S'ha de preguntar cada vegada a l'administrador si
  enviar o no aquests mails.
\item \falta rols
\end{itemize}
...
\item \complert Cada vegada que es dóna d'alta/baixa una quota, enviar un mail al responsable informant-lo.
\item \complert S'ha de preguntar cada vegada a l'administrador si
  enviar o no aquests mails.
\item \falta rols
\end{itemize}
