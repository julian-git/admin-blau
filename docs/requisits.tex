...
\begin{description}
\item[Persones] \progres\falta mail
\item[Categories de persones] \complert
\item[Rols] \complert; sense funcionalitat
\item[Famílies] \progres\falta mail
\item[Quotes] \progres\falta mail
...
\item \complert S'ha de preguntar cada vegada a l'administrador si enviar o no aquests mails.
\end{itemize}
...
\item[R03] \complert Alta, baixa i modificació de quotes 
